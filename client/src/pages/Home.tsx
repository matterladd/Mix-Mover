...
export default function Home() {
  ...
  return (
    <>
      ...
      <form className="flex flex-col md:flex-row p-8 justify-center items-center" onSubmit={handleSubmit}>
        <label htmlFor="appleLink" className="text-nowrap">Apple Music Playlist link:</label>
